    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.reservation.observe(this, Observer { reservation ->
            reservation?.let {
                ...
                binding.eventDate.text = DateTimeUtils.formatDetailTimeString(reservation.event.startTime)
                binding.paymentDate.text = "${DateTimeUtils.formatDetailTimeString(reservation.reservationDate)} 예매"
                ...
                binding.cancelButton.setOnClickListener {
                    viewModel.deleteReservation(reservationId, reservation.event.startTime)
                    finish()
                }
            }
        })
